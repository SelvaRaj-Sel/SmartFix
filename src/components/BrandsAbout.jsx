...
const BrandCard = ({ product }) => {
  return (
    <article
      ...
      className="product-card group relative flex h-full flex-col overflow-hidden rounded-4xl border border-white/15 bg-(--dark2) p-7 text-white transition-[border-color,box-shadow] duration-300 hover:border-white/30 hover:shadow-[0_18px_50px_rgba(2,6,23,0.35)] sm:p-10"
    >
