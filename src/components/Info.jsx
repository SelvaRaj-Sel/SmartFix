...
const Info = () => {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto flex min-h-12 max-w-7xl items-center justify-between gap-4 px-5 py-2 text-sm font-semibold sm:px-8 lg:min-h-14 lg:px-12 lg:text-base">
